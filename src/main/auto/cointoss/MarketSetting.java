...
public abstract class MarketSetting extends MarketSettingModel {
    ...
    protected MarketSetting() {
        ...
        this.targetCurrencyBidSizes = super.targetCurrencyBidSizes();
        this.targetCurrencyScaleSize = super.targetCurrencyScaleSize();
        this.acquirableExecutionSize = super.acquirableExecutionSize();
        this.executionLogger = super.executionLogger();
        this.retryPolicy = super.retryPolicy();
    }
    ...
    /**
     * Assign the new value of retryPolicy property.
     *
     * @paran value The retryPolicy property assigner which accepts the current value and returns new value.
     * @return Chainable API.
     */
    public final MarketSetting retryPolicy(UnaryOperator<RetryPolicy> value) {
        setRetryPolicy(value.apply(this.retryPolicy));
        return this;
    }
     ...
     */
    public static final class Ìnstantiator<Self extends MarketSetting & ÅssignableÅrbitrary<Self>> {
