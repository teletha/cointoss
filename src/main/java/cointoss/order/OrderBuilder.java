 ...
 */
public class OrderBuilder implements Directional {
     ...
     * @param size
     */
    protected OrderBuilder(Side position, Num size, Num price, Num priceLimit, Quantity quantity) {
    ...
    /**
     * Get the triggerPrice property of this {@link OrderBuilder}.
     * 
    ...
    /**
     * Set the triggerPrice property of this {@link OrderBuilder}.
     * 
    ...
    /**
     * Get the quantity property of this {@link OrderBuilder}.
     * 
    ...
    /**
     * Set the quantity property of this {@link OrderBuilder}.
     * 
     ...
     * @return
     */
    public OrderBuilder when(int priceLimit) {
     ...
     * @return
     */
    public OrderBuilder when(Num triggerPrice) {
     ...
     * @return
     */
    public OrderBuilder type(Quantity quantity) {
     ...
     * @return
     */
    public static OrderBuilder market(Side position, Num size) {
        return new OrderBuilder(position, size, null, null, null);
    }
     ...
     * @return
     */
    public static OrderBuilder marketLong(int size) {
     ...
     * @return
     */
    public static OrderBuilder marketLong(Num size) {
     ...
     * @return
     */
    public static OrderBuilder marketShort(int size) {
     ...
     * @return
     */
    public static OrderBuilder marketShort(Num size) {
     ...
     * @return
     */
    public static OrderBuilder limit(Side position, Num size, Num price) {
        OrderBuilder order = new OrderBuilder(position, size, price, null, null);
     ...
     * @return
     */
    public static OrderBuilder limitLong(double size, double price) {
     ...
     * @return
     */
    public static OrderBuilder limitLong(Num size, Num price) {
     ...
     * @return
     */
    public static OrderBuilder limitLong(String size, String price) {
     ...
     * @return
     */
    public static OrderBuilder limitLong(int size, int price) {
        return limitLong(Num.of(size), Num.of(price));
    }
     ...
     * @return
     */
    public static OrderBuilder limitShort(Num size, Num price) {
     ...
     * @return
     */
    public static OrderBuilder limitShort(String size, String price) {
     ...
     * @return
     */
    public static OrderBuilder limitShort(int size, int price) {
        return limitShort(Num.of(size), Num.of(price));
    }
