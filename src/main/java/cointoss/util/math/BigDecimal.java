...
public class BigDecimal extends Number implements Comparable<BigDecimal>, Serializable {
     ...
     * ArithmeticException} for the case that rounding is necessary, i.e. for the case that the
     ...
     */
    private static Pattern unscaledRegex;
    ...
    private static final double[] DOUBLE_FIVE_POW = new double[] {1D, 5D, 25D, 125D, 625D, 3125D, 15625D, 78125D, 390625D, 1953125D,
            9765625D, 48828125D, 244140625D, 1220703125D, 6103515625D, 30517578125D, 152587890625D, 762939453125D, 3814697265625D,
            19073486328125D, 95367431640625D, 476837158203125D, 2384185791015625D,};
     ...
     */
    private static final double[] DOUBLE_TEN_POW = new double[] {1D, 10D, 100D, 1000D, 10000D, 100000D, 1000000D, 10000000D, 100000000D,
     ...
     * val}. The new decimal is constructed as if the {@code BigDecimal(String)} constructor is
     * called with an argument which is equal to {@code
     * Double.toString(val)}. For example, {@code valueOf("0.1")} is converted to (unscaled=1,
     * scale=1), although the double {@code 0.1} cannot be represented exactly as a double value. In
     * contrast to that, a new {@code
    ...
    /**
     * Returns a new {@code BigDecimal} instance whose value is equal to {@code
     * unscaledVal}. The scale of the result is {@code 0}, and its unscaled value is
     * {@code unscaledVal}.
     *
    ...
    /**
     * Returns a new {@code BigDecimal} instance whose value is equal to {@code
     * unscaledVal} 10^(-{@code scale}). The scale of the result is {@code scale}, and its unscaled
    ...
    private static BigDecimal addAndMult10(BigDecimal thisValue, BigDecimal augend, double diffScale) {
        if (diffScale < DOUBLE_TEN_POW.length && Math
                .max(thisValue.bitLength, augend.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale]) + 1 < SMALL_VALUE_BITS) {
            return valueOf(thisValue.smallValue + augend.smallValue * DOUBLE_TEN_POW[(int) diffScale], thisValue.scale);
        }
        return new BigDecimal(thisValue.getUnscaledValue()
                .add(Multiplication.multiplyByTenPow(augend.getUnscaledValue(), (int) diffScale)), thisValue.scale);
    }
    ...
    private static boolean isValidBigUnscaledDecimal(String str) {
        if (unscaledRegex == null) {
            unscaledRegex = Pattern.compile("^[+-]?\\d*$", Pattern.CASE_INSENSITIVE);
        }

        return unscaledRegex.matcher(str).matches();
    }

    private static double parseUnscaled(String str) {
        return isValidBigUnscaledDecimal(str) ? Integer.parseInt(str, 10) : Double.NaN;
    }
    ...
    /**
     * It returns the value 0 with the most approximated scale of type {@code int} . if
     * {@code longScale > Integer.MAX_VALUE} the scale will be {@code
     * Integer.MAX_VALUE}; if {@code longScale < Integer.MIN_VALUE} the scale will be
     * {@code Integer.MIN_VALUE}; otherwise {@code longScale} is casted to the type {@code int}.
     *
    ...
    protected transient int bitLength;
    ...
    /**
     * The arbitrary precision integer (unscaled value) in the internal representation of
     * {@code BigDecimal}.
     */
    protected BigInteger intVal;

    /**
     * Represent the number of decimal digits in the unscaled value. This precision is calculated
     * the first time, and used in the following calls of method <code>precision()</code>. Note that
     * some call to the private method <code>inplaceRound()</code> could update this field.
     *
     * @see #precision()
     * @see #inplaceRound(MathContext)
     */
    protected transient int precision;

    protected double scale;

    /**
     * The unscaled integer value (stored in a double) if the number of bits is less than
     * {@link #SMALL_VALUE_BITS}.
     */
    protected transient double smallValue;

    /**
     * The <code>String</code> representation is cached.
     */
    protected transient String toStringImage;

    /**
     * Constructs a new {@code BigDecimal} instance from the given big integer {@code val}. The
     * scale of the result is {@code 0}.
     *
     ...
     *           mc.roundingMode == UNNECESSARY} and the new big decimal cannot be represented
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from a string representation given as a
     * character array.
     *
     * @param in array of characters containing the string representation of this
     *            {@code BigDecimal}.
     * @throws NullPointerException if {@code in == null}.
     * @throws NumberFormatException if {@code in} does not contain a valid string representation of
     *             a big decimal.
     */
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from a string representation given as a
     * character array. The result is rounded according to the specified math context.
     *
     * @param in array of characters containing the string representation of this
     *            {@code BigDecimal}.
     * @param mc rounding mode and precision for the result of this operation.
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from the given double {@code
     * val}. The scale of the result is 0. The result is rounded according to the specified math
     * context.
     *
     * @param val double value to be converted to a {@code BigDecimal} instance.
     * @param mc rounding mode and precision for the result of this operation.
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from the given int {@code val} . The scale of
     * the result is 0.
     *
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from the given int {@code val} . The scale of
     * the result is {@code 0}. The result is rounded according to the specified math context.
     *
     * @param val int value to be converted to a {@code BigDecimal} instance.
     * @param mc rounding mode and precision for the result of this operation.
     * @throws ArithmeticException if {@code mc.precision > 0} and {@code
     *           c.roundingMode == UNNECESSARY} and the new big decimal cannot be represented within
     *             the given precision without rounding.
     */
    ...
    /**
     * Constructs a new {@code BigDecimal} instance from the given long {@code
     * val}. The scale of the result is {@code 0}. The result is rounded according to the specified
     * math context.
     *
     * @param val long value to be converted to a {@code BigDecimal} instance.
     * @param mc rounding mode and precision for the result of this operation.
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is the absolute value of {@code this}. The
     * result is rounded according to the passed context {@code
     * mc}.
     *
     * @param mc rounding mode and precision for the result of this operation.
     * @return {@code abs(this)}
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code this + augend}. The scale of the
     ...
     * fits to the byte range ([-128..127]). If these conditions are not met, an
     ...
     * this difference is > 0 then 1 is returned, if the difference is < 0 then -1 is returned, and
     * if the difference is 0 then 0 is returned. This means, that if two decimal instances are
     * compared which are equal in value but differ in scale, then these two instances are
     * considered as equal.
     *
     * @param val value to be compared with {@code this}.
     * @return {@code 1} if {@code this > val}, {@code -1} if {@code this < val}, {@code 0} if
     *         {@code this == val}.
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. The scale of the
     * result is the difference of the scales of {@code this} and {@code divisor}. If the exact
     * result requires more digits, then the scale is adjusted accordingly. For example,
     * {@code 1/128 = 0.0078125} which has a scale of {@code 7} and precision {@code 5}.
     *
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. The scale of the
     * result is the scale of {@code this}. If rounding is required to meet the specified scale,
     * then the specified rounding mode {@code
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code this / divisor}. As scale of the
     * result the parameter {@code scale} is used. If rounding is required to meet the specified
     * scale, then the specified rounding mode {@code roundingMode} is applied.
     *
     * @param divisor value by which {@code this} is divided.
     ...
     *           RoundingMode.UNNECESSAR}Y and rounding is necessary according to the given scale
     *             and given precision.
     */
    ...
    public BigDecimal divide(BigDecimal divisor, MathContext mc) {
        /*
         * Calculating how many zeros must be append to 'dividend' to obtain a quotient with at
         * least 'mc.precision()' digits
         */
     ...
     * @throws ArithmeticException if {@code divisor == 0}.
     * @throws ArithmeticException if {@code roundingMode ==
     *           RoundingMode.UNNECESSARY} and rounding is necessary according to the scale of this.
     */
     ...
     * Returns a {@code BigDecimal} array which contains the integral part of {@code this / divisor}
     * at index 0 and the remainder {@code this % divisor} at index 1. The quotient is rounded down
     * towards zero to the next integer. The rounding mode passed with the parameter {@code mc} is
     * not considered. But if the precision of {@code mc > 0} and the integral part requires more
     ...
     * The quotient is rounded down towards zero to the next integer. For example,
     * {@code 0.5/0.2 = 2}.
     *
     * @param divisor value by which {@code this} is divided.
    ...
    public BigDecimal divideToIntegralValue(BigDecimal divisor) {
        ...
        if ((divisor.approxPrecision() + newScale > this.approxPrecision() + 1L) || (this.isZero())) {
            /*
             * If the divisor's integer part is greater than this's integer part, the result must be
             * zero with the appropriate scale
             */
    ...
    public BigDecimal divideToIntegralValue(BigDecimal divisor, MathContext mc) {
        ...
        if (quotPrecision <= 0) {
            ...
            // CASE s2 > s1:
            /*
             * To calculate the minimum power of ten, such that the quotient (u1 * 10^exp) / u2 has
             * at least 'mc.precision()' digits.
             */
    ...
    /**
     * Returns this {@code BigDecimal} as a double value. If {@code this} is too big to be
     * represented as an float, then {@code Double.POSITIVE_INFINITY} or
     ...
     * <p>
     * For example, if the instance {@code x1 = new BigDecimal("0.1")} cannot be represented exactly
     * as a double, and thus {@code x1.equals(new
     * BigDecimal(x1.doubleValue())} returns {@code false} for this case.
     * <p>
     * Similarly, if the instance {@code new BigDecimal(9007199254740993L)} is converted to a
    ...
    /**
     * Returns this {@code BigDecimal} as a float value. If {@code this} is too big to be
     * represented as an float, then {@code Float.POSITIVE_INFINITY} or
     * {@code Float.NEGATIVE_INFINITY} is returned.
     * <p>
     * Note, that if the unscaled value has more than 24 significant digits, then this decimal
     * cannot be represented exactly in a float variable. In this case the result is rounded.
     * <p>
     * For example, if the instance {@code x1 = new BigDecimal("0.1")} cannot be represented exactly
     * as a float, and thus {@code x1.equals(new
     * BigDecimal(x1.folatValue())} returns {@code false} for this case.
     * <p>
     * Similarly, if the instance {@code new BigDecimal(16777217)} is converted to a float, the
    ...
    public float floatValue() {
        /*
         * A similar code like in doubleValue() could be repeated here, but this simple
     ...
     * integral part of {@code this} is too big to be represented as an int, then {@code this} %
     * 2^32 is returned.
     *
    ...
    public int intValue() {
        /*
         * If scale <= -32 there are at least 32 trailing bits zero in 10^(-scale). If the scale is
         * positive and very large the long value could be zero.
         */
     ...
     * fits to the int range ([-2^{31}..2^{31}-1]). If these conditions are not met, an
     * {@code ArithmeticException} is thrown.
     *
     * @return this {@code BigDecimal} as a int value.
     ...
     * integral part of {@code this} is too big to be represented as an long, then {@code this} %
     * 2^64 is returned.
     *
    ...
    public long longValue() {
        /*
         * If scale <= -64 there are at least 64 trailing bits zero in 10^(-scale). If the scale is
         * positive and very large the long value could be zero.
         */
     ...
     * fits to the int range ([-2^{63}..2^{63}-1]). If these conditions are not met, an
     * {@code ArithmeticException} is thrown.
     *
     * @return this {@code BigDecimal} as a long value.
     ...
     * <p>
     * Note, that {@code movePointLeft(0)} returns a result which is mathematically equivalent, but
    ...
    /**
     * Returns a new {@code BigDecimal} instance where the decimal point has been moved {@code n}
     * places to the right. If {@code n < 0} then the decimal point is moved {@code -n} places to
     * the left.
     * <p>
     * The result is obtained by changing its scale. If the scale of the result becomes negative,
     * then its precision is increased such that the scale is zero.
     * <p>
     * Note, that {@code movePointRight(0)} returns a result which is mathematically equivalent, but
     * which has scale >= 0.
     *
     * @param n number of placed the decimal point has to be moved.
     * @return {@code this * 10^n}.
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code this * multiplicand} . The scale of
     * the result is the sum of the scales of the two arguments.
     *
    ...
    public BigDecimal multiply(BigDecimal multiplicand) {
        ...
        /*
         * Let be: this = [u1,s1] and multiplicand = [u2,s2] so: this x multiplicand = [ s1 * s2 ,
         * s1 + s2 ]
         */
    ...
    /**
     * Returns a new {@code BigDecimal} whose value is {@code +this}. The result is rounded
     * according to the passed context {@code mc}.
     *
     * @param mc rounding mode and precision for the result of this operation.
    ...
    public BigDecimal pow(int n) {
        ...
        return ((isZero()) ? zeroScaledBy(newScale) : new BigDecimal(getUnscaledValue().pow(n), toIntScale(newScale)));
    }
    ...
    /**
     * Returns the precision of this {@code BigDecimal}. The precision is the number of decimal
     * digits used to represent this decimal. It is equivalent to the number of digits of the
     * unscaled value. The precision of {@code 0} is {@code 1} (independent of the scale).
     *
    ...
    public int precision() {
        ...
        if (bitLength < SMALL_VALUE_BITS) {
            ...
            // (bitLength >= 1024)
            /*
             * To calculate the precision for large numbers Note that: 2 ^(bitlength() - 1) <=
             * intVal < 10 ^(precision())
             */
     ...
     * @throws NullPointerException if {@code divisor == null}.
     * @throws ArithmeticException if {@code divisor == 0}.
     * @throws ArithmeticException if {@code mc.getPrecision() > 0} and the result of
     *             {@code this.divideToIntegralValue(divisor, mc)} requires more digits to be
     *             represented.
     */
     ...
     * <p>
     * If {@code mc.precision > 0} and {@code mc.roundingMode == UNNECESSARY}, then an
     * {@code ArithmeticException} is thrown if the result cannot be represented exactly within the
     * given precision.
     *
     * @param mc rounding mode and precision for the result of this operation.
     * @return {@code this} rounded according to the passed context.
     * @throws ArithmeticException if {@code mc.precision > 0} and {@code
     *           mc.roundingMode == UNNECESSARY} and this cannot be represented within the given
     *             precision.
     */
     ...
     * decimal point. The value of this {@code BigDecimal} is the unsignedValue * 10^(-scale). If
     * the scale is negative, then this {@code BigDecimal} represents a big integer.
     *
     ...
     * {@code this}.
     * <p>
     * This method has the same effect as {@link #movePointRight}, except that the precision is not
     * changed.
     *
    ...
    /**
     * Returns a new {@code BigDecimal} instance with the specified scale. If the new scale is
     * greater than the old scale, then additional zeros are added to the unscaled value. If the new
     * scale is smaller than the old scale, then trailing zeros are removed. If the trailing digits
     * are not zeros then an ArithmeticException is thrown.
     * <p>
     ...
     * <p>
     * If the new scale is greater than the old scale, then additional zeros are added to the
     * unscaled value. In this case no rounding is necessary.
     * <p>
     * If the new scale is smaller than the old scale, then trailing digits are removed. If these
    ...
    /**
     * Returns this {@code BigDecimal} as a short value if it has no fractional part and if its
     * value fits to the short range ([-2^{15}..2^{15}-1]). If these conditions are not met, an
     * {@code ArithmeticException} is thrown.
     *
     ...
     *
     * @return {@code -1} if {@code this < 0}, {@code 0} if {@code this == 0}, {@code 1} if
     *         {@code this > 0}.
     */
    public int signum() {
        if (bitLength < SMALL_VALUE_BITS) {
     ...
     * this} but with a unscaled value where the trailing zeros have been removed. If the unscaled
     * value of {@code this} has n trailing zeros, then the scale and the precision of the result
     * has been reduced by n.
     *
    ...
    public BigDecimal subtract(BigDecimal subtrahend) {
        ...
        if (diffScale == 0) {
            ...
            // case s1 > s2 : [ u1 - u2 * 10 ^ (s1 - s2) , s1 ]
            if (diffScale < DOUBLE_TEN_POW.length && Math
                    .max(this.bitLength, subtrahend.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale]) + 1 < SMALL_VALUE_BITS) {
                return valueOf(this.smallValue - subtrahend.smallValue * DOUBLE_TEN_POW[(int) diffScale], this.scale);
            }
            return new BigDecimal(this.getUnscaledValue()
                    .subtract(Multiplication.multiplyByTenPow(subtrahend.getUnscaledValue(), (int) diffScale)), this.scale);
        } else {
            // case s2 > s1 : [ u1 * 10 ^ (s2 - s1) - u2 , s2 ]
            diffScale = -diffScale;
            if (diffScale < DOUBLE_TEN_POW.length && Math
                    .max(this.bitLength + DOUBLE_TEN_POW_BIT_LENGTH[(int) diffScale], subtrahend.bitLength) + 1 < SMALL_VALUE_BITS) {
    ...
    /**
     * Returns this {@code BigDecimal} as a big integer instance if it has no fractional part. If
     * this {@code BigDecimal} has a fractional part, i.e. if rounding would be necessary, an
     * {@code ArithmeticException} is thrown.
     *
     ...
     * <p>
     * If the scale is negative or if {@code scale - precision >= 6} then engineering notation is
     ...
     * <p>
     * If this string representation is used to create a new instance, this instance is generally
    ...
    /**
     * Returns a canonical string representation of this {@code BigDecimal}. If necessary,
     * scientific notation is used. This representation always prints all significant digits of this
     * value.
     * <p>
     * If the scale is negative or if {@code scale - precision >= 6} then scientific notation is
     * used.
     *
    ...
    /**
     * Returns the unscaled value (mantissa) of this {@code BigDecimal} instance as a
     * {@code BigInteger}. The unscaled value can be computed as {@code this} 10^(scale).
     *
     ...
     * good approximation efficiently . Note that this value will be {@code precision()} or
     * {@code precision()-1} in the worst case.
     *
    ...
    private void inplaceRound(MathContext mc) {
        ...
        if (integerAndFraction[1].signum() != 0) {
            ...
            // To look if there is a carry
            compRem = roundingBehavior(integerAndFraction[0].testBit(0) ? 1 : 0, integerAndFraction[1].signum() * (5 + compRem), mc
                    .getRoundingMode());
            if (compRem != 0) {
    ...
    private BigDecimal movePoint(double newScale) {
        ...
        /*
         * When: 'n'== Integer.MIN_VALUE isn't possible to call to movePointRight(-n) since
    ...
    /**
     * This method implements an efficient rounding for numbers which unscaled value fits in the
     * type {@code long}.
     *
    ...
    /**
     * If {@code intVal} has a fractional part throws an exception, otherwise it counts the number
     * of bits of value and checks if it's out of the range of the primitive type. If the number
     * fits in the primitive type returns this number as {@code long}, otherwise throws an
     * exception.
     *
     ...
     * @throws ArithmeticException when rounding is necessary or the number don't fit in the
     *             primitive type
     */
