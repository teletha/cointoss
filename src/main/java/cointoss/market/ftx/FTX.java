...
public final class FTX extends MarketServiceProvider {
    ...
    static final MarketService ADA_PERP = new FTXService("ADA-PERP", MarketSetting.with.derivative()
            .target(Currency.ADA.minimumSize(1))
            .base(Currency.USD.minimumSize(0.000005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService AMPL_PERP = new FTXService("AMPL-PERP", MarketSetting.with.derivative()
            .target(Currency.AMPL.minimumSize(1))
            .base(Currency.USD.minimumSize(0.0001))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService ATOM_PERP = new FTXService("ATOM-PERP", MarketSetting.with.derivative()
            .target(Currency.ATOM.minimumSize(0.01))
            .base(Currency.USD.minimumSize(0.0005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService AVAX_PERP = new FTXService("AVAX-PERP", MarketSetting.with.derivative()
            .target(Currency.AVAX.minimumSize(0.1))
            .base(Currency.USD.minimumSize(0.001))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService BNB_PERP = new FTXService("BNB-PERP", MarketSetting.with.derivative()
            .target(Currency.BNB.minimumSize(0.1))
            .base(Currency.USD.minimumSize(0.0005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService BTC_PERP = new FTXService("BTC-PERP", MarketSetting.with.derivative()
    ...
    static final MarketService EOS_PERP = new FTXService("EOS-PERP", MarketSetting.with.derivative()
            .target(Currency.EOS.minimumSize(0.1))
            .base(Currency.USD.minimumSize(0.00005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService ETH_PERP = new FTXService("ETH-PERP", MarketSetting.with.derivative()
    ...
    static final MarketService LINK_PERP = new FTXService("LINK-PERP", MarketSetting.with.derivative()
            .target(Currency.LINK.minimumSize(0.1))
            .base(Currency.USD.minimumSize(0.0005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService SOL_PERP = new FTXService("SOL-PERP", MarketSetting.with.derivative()
            .target(Currency.SOL.minimumSize(0.01))
            .base(Currency.USD.minimumSize(0.0005))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService COMP_PERP = new FTXService("COMP-PERP", MarketSetting.with.derivative()
    ...
    static final MarketService DEFI_PERP = new FTXService("DEFI-PERP", MarketSetting.with.derivative()
            .target(Currency.FTX_DEFI.minimumSize(0.001))
            .base(Currency.USD.minimumSize(0.1))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService ALT_PERP = new FTXService("ALT-PERP", MarketSetting.with.derivative()
            .target(Currency.FTX_ALT.minimumSize(0.001))
            .base(Currency.USD.minimumSize(0.01))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService MID_PERP = new FTXService("MID-PERP", MarketSetting.with.derivative()
            .target(Currency.FTX_MID.minimumSize(0.001))
            .base(Currency.USD.minimumSize(0.1))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService SHIT_PERP = new FTXService("SHIT-PERP", MarketSetting.with.derivative()
            .target(Currency.FTX_SHIT.minimumSize(0.001))
            .base(Currency.USD.minimumSize(0.1))
            .acquirableExecutionSize(AcquirableSize));

    static final MarketService DOGE_PERP = new FTXService("DOGE-PERP", MarketSetting.with.derivative()
