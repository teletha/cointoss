 ...
 */
public class AverageLossIndicator extends AbstractPeriodicalDelegationIndicator {
     ...
     * @param period
     */
    public AverageLossIndicator(Indicator<Amount> indicator, int period) {
        super(new CumulatedLossesIndicator(indicator, period), period);
