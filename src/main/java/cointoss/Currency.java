...
public class Currency implements Comparable<Currency>, Serializable {
     ...
     * <p>
     * This is useful in case some currencies share codes, such that {@link #getInstance(String)}
    ...
    /**
     * Gets the equivalent object with an ISO 4217 code, or if none a code which looks ISO
     * compatible (starts with an X), or the constructed currency code if neither exist.
     */
