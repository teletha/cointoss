...
public class DuckExe {
    ...
    public static void main(String[] args) {
        I.load(DuckExe.class);

        I.env("typewriter.duckdb", "jdbc:duckdb:" + Locator.file("duck-exe.db").absolutize());

        RDB<FastTick> db = RDB.of(Execution.class);
    ...
    private static class FastTick extends DuckModel<FastTick> {
        ...
        /**
         * Get the hight property of this {@link DuckExe.FastTick}.
         * 
        ...
        /**
         * Set the hight property of this {@link DuckExe.FastTick}.
         * 
        ...
        /**
         * Get the low property of this {@link DuckExe.FastTick}.
         * 
        ...
        /**
         * Set the low property of this {@link DuckExe.FastTick}.
         * 
