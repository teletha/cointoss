 ...
 * https://forums.oracle.com/forums/thread.jspa?threadID=2435995 "Using StackPane to layer more
...
public class LayeredXyChartsSample extends Application {
    ...
    public void start(Stage stage) {
        stage.setScene(new Scene(layerCharts(createBarChart(), createLineChart())));
        stage.show();
    }
    ...
    private BarChart<String, Number> createBarChart() {
        ...
        chart.getData().addAll(new XYChart.Series(FXCollections
                .observableArrayList(new XYChart.Data("Jan", 2), new XYChart.Data("Feb", 10), new XYChart.Data("Mar", 8), new XYChart.Data("Apr", 4), new XYChart.Data("May", 7), new XYChart.Data("Jun", 5), new XYChart.Data("Jul", 4), new XYChart.Data("Aug", 8), new XYChart.Data("Sep", 16.5), new XYChart.Data("Oct", 13.9), new XYChart.Data("Nov", 17), new XYChart.Data("Dec", 10))));
        return chart;
    }
    ...
    private LineChart<String, Number> createLineChart() {
        ...
        chart.getData().addAll(new XYChart.Series(FXCollections
                .observableArrayList(new XYChart.Data("Jan", 1), new XYChart.Data("Feb", 2), new XYChart.Data("Mar", 1.5), new XYChart.Data("Apr", 3), new XYChart.Data("May", 2.5), new XYChart.Data("Jun", 5), new XYChart.Data("Jul", 4), new XYChart.Data("Aug", 8), new XYChart.Data("Sep", 6.5), new XYChart.Data("Oct", 13), new XYChart.Data("Nov", 10), new XYChart.Data("Dec", 20))));
        return chart;
    }
