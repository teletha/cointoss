...
public class QLTutorial extends MDPSolver implements LearningAgent, QProvider {
    ...
    public QLTutorial(SADomain domain, double gamma, HashableStateFactory hashingFactory, QFunction qinit, double learningRate, double epsilon) {
    ...
    public static void main(String[] args) {
        ...
        // create Q-learning
        QLTutorial agent = new QLTutorial(domain, 0.99, new SimpleHashableStateFactory(), new ConstantValueFunction(), 0.1, 0.1);
