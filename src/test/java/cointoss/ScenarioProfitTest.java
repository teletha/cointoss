...
class ScenarioProfitTest extends TraderTestSupport {
    ...
    // @Test
    // void snapshotPartialEntryAndIncompleteExit() {
    // entryPartialAndExit(Execution.with.buy(3).price(10), 2,
    // Execution.with.sell(1).price(20).date(minute(5)));
    //
    // // past
    // Profitable snapshot = snapshotAt(minute(1));
    // assert snapshot.realizedProfit().is(0);
    ...
    // @Test
    // void snapshotPartialEntryAndPartialExit() {
    // entryPartialAndExitPartial(Execution.with.buy(2).price(10), 1,
    // Execution.with.sell(2).price(20).date(minute(5)), 1);
    //
    // // past
    // Profitable snapshot = snapshotAt(minute(1));
    // assert snapshot.realizedProfit().is(0);
