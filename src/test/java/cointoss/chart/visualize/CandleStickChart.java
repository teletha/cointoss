...
public class CandleStickChart extends XYChart<Number, Number> {
     ...
     * @param xAxis The x axis to use
     * @param yAxis The y axis to use
     * @param data The data to use, this is the actual list used so any changes to it will be
            ...
            while (iter.hasNext()) {
                ...
                if (itemNode instanceof Candle && extra != null) {
                    ...
                    if (getXAxis() instanceof NumberAxis) {
                        ...
                        candleWidth = xa.getDisplayPosition(xa.getTickUnit()) * 0.90; // use 90%
                                                                                      // width
                                                                                      // between
                                                                                      // ticks
                    }
