...
class OrderManagerTest {
    ...
    void request() {
        ...
        orders.requestNow(MyOrder.buy(1).price(10));
        assert orders.items.size() == 1;
    }

    @Test
    void cancel() {
        Order order = orders.requestNow(MyOrder.buy(1).price(10));
        assert orders.items.size() == 1;
    ...
    void removedByCancel() {
        Order order1 = orders.requestNow(MyOrder.buy(1).price(10));
        Order order2 = orders.requestNow(MyOrder.buy(1).price(10));
    ...
    void removedByExecuteDividedly() {
        orders.requestNow(MyOrder.buy(2).price(10));
