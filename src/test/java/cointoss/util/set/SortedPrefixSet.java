...
public interface SortedPrefixSet extends SortedSet<Wrapper>, PrefixSet {
     ...
     */
    SortedPrefixSet subSet(Primitive fromElement, Primitive toElement);
     ...
     *             {@code toElement} lies outside the bounds of the range
     */
    SortedPrefixSet headSet(Primitive toElement);
     ...
     */
    SortedPrefixSet tailSet(Primitive fromElement);
