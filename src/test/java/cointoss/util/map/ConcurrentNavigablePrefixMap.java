 ...
 */
public interface ConcurrentNavigablePrefixMap<V> extends ConcurrentNavigableMap<Wrapper, V>, ConcurrentPrefixMap<V>, NavigablePrefixMap<V> {

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> subMap(Wrapper fromKey, boolean fromInclusive, Wrapper toKey, boolean toInclusive) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> subMap(Primitive fromKey, boolean fromInclusive, Primitive toKey, boolean toInclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> headMap(Wrapper toKey, boolean inclusive) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> headMap(Primitive toKey, boolean inclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> tailMap(Wrapper fromKey, boolean inclusive) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> tailMap(Primitive fromKey, boolean inclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> subMap(Wrapper fromKey, Wrapper toKey) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> subMap(Primitive fromKey, Primitive toKey);

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> headMap(Wrapper toKey) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> headMap(Primitive toKey);

    /**
     * {@inheritDoc}
     */
    @Override
    default ConcurrentNavigablePrefixMap<V> tailMap(Wrapper fromKey) {
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> tailMap(Primitive fromKey);
     ...
     */
    @Override
    ConcurrentNavigablePrefixMap<V> descendingMap();
}
