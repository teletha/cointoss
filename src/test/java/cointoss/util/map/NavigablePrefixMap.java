...
public interface NavigablePrefixMap<V> extends NavigableMap<Wrapper, V> {
     ...
     */
    @Override
    NavigablePrefixMap<V> descendingMap();
     ...
     */
    NavigablePrefixMap<V> subMap(Primitive fromKey, boolean fromInclusive, Primitive toKey, boolean toInclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default NavigablePrefixMap<V> headMap(Wrapper toKey, boolean inclusive) {
     ...
     */
    NavigablePrefixMap<V> headMap(Primitive toKey, boolean inclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default NavigablePrefixMap<V> tailMap(Wrapper fromKey, boolean inclusive) {
     ...
     */
    NavigablePrefixMap<V> tailMap(Primitive fromKey, boolean inclusive);

    /**
     * {@inheritDoc}
     */
    @Override
    default NavigablePrefixMap<V> subMap(Wrapper fromKey, Wrapper toKey) {
     ...
     */
    NavigablePrefixMap<V> subMap(Primitive fromKey, Primitive toKey);

    /**
     * {@inheritDoc}
     */
    @Override
    default NavigablePrefixMap<V> headMap(Wrapper toKey) {
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    NavigablePrefixMap<V> headMap(Primitive toKey);

    /**
     * {@inheritDoc}
     */
    @Override
    default NavigablePrefixMap<V> tailMap(Wrapper fromKey) {
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    NavigablePrefixMap<V> tailMap(Primitive fromKey);
}
