...
class FTXPublicServiceTest {
    ...
    // websocketServer.replyWhenJSON("{'channel':'trades','market':'BTC-PERP','op':'subscribe'}",
    // server -> {
    // server.sendJSON("{'type': 'subscribed', 'channel': 'trades', 'market': 'BTC-PERP'}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
    // [{'id': 85016992, 'price': 11902.5, 'size': 0.0062, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:16.518762+00:00'}, {'id': 85016993, 'price': 11902.5, 'size':
    // 0.0022, 'side': 'sell', 'liquidation': false, 'time': '2020-08-15T07:51:16.518762+00:00'},
    // {'id': 85016994, 'price': 11902.5, 'size': 0.001, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:16.518762+00:00'}, {'id': 85016995, 'price': 11902.0, 'size':
    // 0.0021, 'side': 'sell', 'liquidation': false, 'time': '2020-08-15T07:51:16.518762+00:00'},
    // {'id': 85016996, 'price': 11901.5, 'size': 0.1567, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:16.518762+00:00'}]}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
    // [{'id': 85017027, 'price': 11901.5, 'size': 0.9274, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:19.938929+00:00'}, {'id': 85017028, 'price': 11901.0, 'size': 0.02,
    // 'side': 'sell', 'liquidation': false, 'time': '2020-08-15T07:51:19.938929+00:00'}]}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
    // [{'id': 85017029, 'price': 11900.5, 'size': 0.004, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:20.147541+00:00'}]}");
    // });
    //
    ...
    // server.sendJSON("{'type': 'subscribed', 'channel': 'trades', 'market': 'BTC-PERP'}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
    // [{'id': 85022383, 'price': 11922.0, 'size': 0.2, 'side': 'buy', 'liquidation': false, 'time':
    // '2020-08-15T08:02:27.515786+00:00'}, {'id': 85022384, 'price': 11922.0, 'size': 0.0028,
    // 'side': 'buy', 'liquidation': false, 'time': '2020-08-15T08:02:27.515786+00:00'}, {'id':
    // 85022385, 'price': 11922.0, 'size': 0.0019, 'side': 'buy', 'liquidation': false, 'time':
    // '2020-08-15T08:02:27.515786+00:00'}]}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
    // [{'id': 85022387, 'price': 11923.5, 'size': 0.0055, 'side': 'buy', 'liquidation': false,
    // 'time': '2020-08-15T08:02:27.837360+00:00'}]}");
    // });
    //
    // List<Execution> list = service.executionsRealtimely().toList();
    // assert list.size() == 4;
    ...
    // {'id': 85016996, 'price': 11901.5, 'size': 0.1567, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:16.518762+00:00'}]}");
    // server.sendJSON("{'channel': 'trades', 'market': 'ETH-PERP', 'type': 'update', 'data':
    // [{'id': 85017027, 'price': 11901.5, 'size': 0.9274, 'side': 'sell', 'liquidation': false,
    // 'time': '2020-08-15T07:51:19.938929+00:00'}, {'id': 85017028, 'price': 11901.0, 'size': 0.02,
    // 'side': 'sell', 'liquidation': false, 'time': '2020-08-15T07:51:19.938929+00:00'}]}");
    // server.sendJSON("{'channel': 'trades', 'market': 'BTC-PERP', 'type': 'update', 'data':
